...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("23/02/2020"), "Partiu viagem", "Vou viajar para São Paulo. Oyasumi Minna!", wendy);
		Post post2 = new Post(null, sdf.parse("26/02/2020"), "Ohayo", "Acordei feliz hoje!", wendy);
